...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    <div class="main-wrapper">
      ...
      <nav id="navbar-collapse" class="navbar navbar-fixed-top">
        <div class="container">
      ...
      <section id="company" class="container">
        <div class="row">
          <div class="col-md-4 col-sm-4">
            ...
            <section id= "company-info" class="right-bar row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                  ...
                  <table>
                    ...
                    <tr>
                      ...
                      <td class="detail">
                        <a href="tel:+994505050505">(050)505-0505</a>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td class="detail">
                        <a href="https://www.facebook.com/azercell/?fref=ts">Facebook</a>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td class="detail">
                        <a href="http://www.azercell.com">Website</a>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td class="detail">
                        <a href="http://www.twitter.com/azercell">Twitter</a>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td class="detail">
                        <span>Azadlıq Prospekti, 23</span>
                      </td>
                    </tr>
                  </table>
                </div>
                  ...
                  <div class="post-item-actions">
                    <ul class="list-unstyled">
                      <li class="add-reminder">
                        <i class="material-icons md-24 add-reminder">add_alert</i>
                  ...
                  <div class="post-item-actions">
                    <form class="" action="index.html" method="post">
                      <div class="form-group">
                        <label for="datetime">Choose date and time for reminder</label>
      ...
      <div id="popUp">
        <h3>Choose date and time for reminder</h3>
        <div class="form-group">
      ...
      <footer id="footer">
        ...
        <section id="copyright">
          <div class="container">
          <h6 class="pull-left">Copyrights © 2015 All Rights Reserved</h6>
          <a href="#"><i class="fa fa-facebook pull-right" aria-hidden="true"></i></a>
          <a href="#"><i class="fa fa-twitter pull-right" aria-hidden="true"></i></a>
          <a href="#"><i class="fa fa-envelope pull-right" aria-hidden="true"></i></a>
        </div>
        </section>
      </footer>
    ...
    <script src="{{url('/assets/js/alignItemsHeight-company.js')}}"></script>
